...
function MonthNav({ month, setMonth }) {
  ...
  return /*#__PURE__*/React.createElement('div', {
    style: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 2, padding: '16px 20px 4px' }
  },
    ...
    /*#__PURE__*/React.createElement(NavArrow, { icon: /*#__PURE__*/React.createElement(IconChevronRight, {}), onClick: () => setMonth(m => addMonths(m, 1)), disabled: isCurrent })
  );
}
...
function MonthComparison({ rev, prevRev, count, prevCount, avgBasket, prevAvg }) {
  return /*#__PURE__*/React.createElement('div', {
    style: {
...
function TopProductsCard({ topProducts }) {
  if (topProducts.length === 0) return /*#__PURE__*/React.createElement(EmptyCard, { text: 'Pas encore de ventes ce mois-ci' });
  return /*#__PURE__*/React.createElement('div', {
    style: { margin: '0 20px 24px', display: 'flex', flexDirection: 'column', gap: 8 }
  },
...
export function MonthlyAnalysis({ orders, onSelectDay }) {
  const [month, setMonth] = React.useState(() => new Date());

  const monthOrders = React.useMemo(
    () => orders.filter(o => monthKey(o.date) === monthKey(month) && o.status !== 'annulee'),
    [orders, month]
  );
  const prevMonthDate = addMonths(month, -1);
  const prevMonthOrders = React.useMemo(
    () => orders.filter(o => monthKey(o.date) === monthKey(prevMonthDate) && o.status !== 'annulee'),
    [orders, month]
  );
  ...
  return /*#__PURE__*/React.createElement('div', { style: { paddingBottom: 8 } },
    /*#__PURE__*/React.createElement(MonthNav, { month, setMonth }),

    /*#__PURE__*/React.createElement(HeroRevenue, { value: fp(rev), tag: 'du mois' }),

    hasPrevData && /*#__PURE__*/React.createElement(MonthComparison, { rev, prevRev, count, prevCount, avgBasket, prevAvg }),

    /*#__PURE__*/React.createElement('div', {
      style: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, margin: '0 20px 20px' }
    },
    ...
    /*#__PURE__*/React.createElement(MonthlyCategoryList, { categoryStats, categoryTotal }),
